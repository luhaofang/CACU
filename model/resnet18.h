...
network* resnet18_xnor(type phrase = train) {
	...
	bc1->set_params_init_value("w", gaussian,0.001);
...
//	net << relu1_b;
	...
	batch_normalization_layer *bn_1c = new batch_normalization_layer("bn_1c",
			56,    //input_dim
			64, phrase);   //channel
	bn_1c->bottoms << bc_1b->tops[0];//relu1_b->tops[0];
	...
	bc_2a->set_params_init_value("real_w", msra);
	net << bc_2a;
	...
	bc_2b->set_params_init_value("real_w", msra);
	net << bc_2b;
...
//	net << relu2_b;
	...
	batch_normalization_layer *bn_2c = new batch_normalization_layer("bn_2c",
			56,    //input_dim
			64, phrase);   //channel
	bn_2c->bottoms << bc_2b->tops[0];//relu2_b->tops[0];
	...
	bc_2c->set_params_init_value("real_w", msra);
	net << bc_2c;
	...
	bc_3a->set_params_init_value("real_w", msra);
	net << bc_3a;
	...
	bc_3b->set_params_init_value("real_w", msra);
	net << bc_3b;
...
//	net << relu3_b;
	...
	batch_normalization_layer *bn_3c = new batch_normalization_layer("bn_3c",
			28,    //input_dim
			128, phrase);   //channel
	bn_3c->bottoms << bc_3b->tops[0];//relu3_b->tops[0];
	...
	bc_3c->set_params_init_value("real_w", msra);
	net << bc_3c;
	...
	bc_4a->set_params_init_value("real_w", msra);
	net << bc_4a;
	...
	bc_4b->set_params_init_value("real_w", msra);
	net << bc_4b;
...
//	net << relu4_b;
	...
	batch_normalization_layer *bn_4c = new batch_normalization_layer("bn_4c",
			28,    //input_dim
			128, phrase);   //channel
	bn_4c->bottoms << bc_4b->tops[0];//relu4_b->tops[0];
	...
	bc_4c->set_params_init_value("real_w", msra);
	net << bc_4c;
	...
	bc_5a->set_params_init_value("real_w", msra);
	net << bc_5a;
	...
	bc_5b->set_params_init_value("real_w", msra);
	net << bc_5b;
...
//	net << relu5_b;
	...
	batch_normalization_layer *bn_5c = new batch_normalization_layer("bn_5c",
			14,    //input_dim
			256, phrase);   //channel
	bn_5c->bottoms << bc_5b->tops[0];//relu5_b->tops[0];
	...
	bc_5c->set_params_init_value("real_w", msra);
	net << bc_5c;
	...
	bc_6a->set_params_init_value("real_w", msra);
	net << bc_6a;
	...
	bc_6b->set_params_init_value("real_w", msra);
	net << bc_6b;
...
//	net << relu6_b;
	...
	batch_normalization_layer *bn_6c = new batch_normalization_layer("bn_6c",
			14,    //input_dim
			256, phrase);   //channel
	bn_6c->bottoms << bc_6b->tops[0];//relu6_b->tops[0];
	...
	bc_6c->set_params_init_value("real_w", msra);
	net << bc_6c;
	...
	bc_7a->set_params_init_value("real_w", msra);
	net << bc_7a;
	...
	bc_7b->set_params_init_value("real_w", msra);
	net << bc_7b;
...
//	net << relu7_b;
	...
	batch_normalization_layer *bn_7c = new batch_normalization_layer("bn_7c", 7, //input_dim
			512, phrase);   //channel
	bn_7c->bottoms << bc_7b->tops[0];//relu7_b->tops[0];
	...
	bc_7c->set_params_init_value("real_w", msra);
	net << bc_7c;
	...
	bc_8a->set_params_init_value("real_w", msra);
	net << bc_8a;
	...
	bc_8b->set_params_init_value("real_w", msra);
	net << bc_8b;
...
//	net << relu8_b;
	...
	batch_normalization_layer *bn_8c = new batch_normalization_layer("bn_8c", 7, //input_dim
			512, phrase);   //channel
	bn_8c->bottoms << bc_8b->tops[0];//relu8_b->tops[0];
	...
	bc_8c->set_params_init_value("real_w", msra);
	net << bc_8c;
