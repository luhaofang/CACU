...
network* resnet18(type phrase = train)
{
	...
	conv_layer *bc1 = new conv_layer("bc1",
		224,   //input_dim
		3,	   //channel
		64,	   //output_channel
		7,	   //kernel_size
	...
	bin_activation_layer *ba_1a = new bin_activation_layer("ba_1a",
		56,    //input_dim
		64,	   //channel
		1,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_1a = new bin_conv_layer("bc_1a",
		56,    //input_dim
		64,	   //channel
		64,   //output_channel
		1,	   //kernel_size
	...
	bin_conv_layer *bc_1b = new bin_conv_layer("bc_1b",
		56,    //input_dim
		64,	   //channel
		64,   //output_channel
		3,	   //kernel_size
	...
	bin_activation_layer *ba_1c = new bin_activation_layer("ba_1c",
		56,    //input_dim
		64,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_1c = new bin_conv_layer("bc_1c",
		56,    //input_dim
		64,	   //channel
		64,   //output_channel
		3,	   //kernel_size
	...
	eltwise_layer *el_1 = new eltwise_layer("el_1",
		56,
		64, phrase);
	...
	bin_conv_layer *bc_2a = new bin_conv_layer("bc_2a",
		56,    //input_dim
		64,	   //channel
		64,   //output_channel
		1,	   //kernel_size
	...
	bin_conv_layer *bc_2b = new bin_conv_layer("bc_2b",
		56,    //input_dim
		64,	   //channel
		64,   //output_channel
		3,	   //kernel_size
	...
	bin_activation_layer *ba_2c = new bin_activation_layer("ba_2c",
		56,    //input_dim
		64,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_2c = new bin_conv_layer("bc_2c",
		56,    //input_dim
		64,	   //channel
		64,   //output_channel
		3,	   //kernel_size
	...
	eltwise_layer *el_2 = new eltwise_layer("el_2",
		56,
		64, phrase);
	...
	bin_conv_layer *bc_3a = new bin_conv_layer("bc_3a",
		56,    //input_dim
		64,	   //channel
		128,   //output_channel
		1,	   //kernel_size
	...
	bin_conv_layer *bc_3b = new bin_conv_layer("bc_3b",
		56,    //input_dim
		64,	   //channel
		128,   //output_channel
		3,	   //kernel_size
	...
	bin_activation_layer *ba_3c = new bin_activation_layer("ba_3c",
		28,    //input_dim
		128,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_3c = new bin_conv_layer("bc_3c",
		28,    //input_dim
		128,	   //channel
		128,   //output_channel
		3,	   //kernel_size
	...
	eltwise_layer *el_3 = new eltwise_layer("el_3",
		28,
		128, phrase);
	...
	bin_conv_layer *bc_4a = new bin_conv_layer("bc_4a",
		28,    //input_dim
		128,	   //channel
		128,   //output_channel
		1,	   //kernel_size
	...
	bin_conv_layer *bc_4b = new bin_conv_layer("bc_4b",
		28,    //input_dim
		128,	   //channel
		128,   //output_channel
		3,	   //kernel_size
	...
	bin_activation_layer *ba_4c = new bin_activation_layer("ba_4c",
		28,    //input_dim
		128,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_4c = new bin_conv_layer("bc_4c",
		28,    //input_dim
		128,	   //channel
		128,   //output_channel
		3,	   //kernel_size
	...
	eltwise_layer *el_4 = new eltwise_layer("el_4",
		28,
		128, phrase);
	...
	bin_conv_layer *bc_5a = new bin_conv_layer("bc_5a",
		28,    //input_dim
		128,	   //channel
		256,   //output_channel
		1,	   //kernel_size
	...
	bin_conv_layer *bc_5b = new bin_conv_layer("bc_5b",
		28,    //input_dim
		128,	   //channel
		256,   //output_channel
		3,	   //kernel_size
	...
	bin_activation_layer *ba_5c = new bin_activation_layer("ba_5c",
		14,    //input_dim
		256,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_5c = new bin_conv_layer("bc_5c",
		14,    //input_dim
		256,	   //channel
		256,   //output_channel
		3,	   //kernel_size
	...
	eltwise_layer *el_5 = new eltwise_layer("el_5",
		14,
		256, phrase);
	...
	bin_conv_layer *bc_6a = new bin_conv_layer("bc_6a",
		14,    //input_dim
		256,	   //channel
		256,   //output_channel
		1,	   //kernel_size
	...
	bin_conv_layer *bc_6b = new bin_conv_layer("bc_6b",
		14,    //input_dim
		256,	   //channel
		256,   //output_channel
		3,	   //kernel_size
	...
	bin_activation_layer *ba_6c = new bin_activation_layer("ba_6c",
		14,    //input_dim
		256,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_6c = new bin_conv_layer("bc_6c",
		14,    //input_dim
		256,	   //channel
		256,   //output_channel
		3,	   //kernel_size
	...
	eltwise_layer *el_6 = new eltwise_layer("el_6",
		14,
		256, phrase);
	...
	bin_conv_layer *bc_7a = new bin_conv_layer("bc_7a",
		14,    //input_dim
		256,	   //channel
		512,   //output_channel
		1,	   //kernel_size
	...
	bin_conv_layer *bc_7b = new bin_conv_layer("bc_7b",
		14,    //input_dim
		256,	   //channel
		512,   //output_channel
		3,	   //kernel_size
	...
	batch_normalization_layer *bn_7c = new batch_normalization_layer("bn_7c",
		7,    //input_dim		
		512, phrase);   //channel
	...
	bin_activation_layer *ba_7c = new bin_activation_layer("ba_7c",
		7,    //input_dim
		512,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_7c = new bin_conv_layer("bc_7c",
		7,    //input_dim
		512,	   //channel
		512,   //output_channel
		3,	   //kernel_size
	...
	eltwise_layer *el_7 = new eltwise_layer("el_7",
		7,
		512, phrase);
	...
	//forth-2 shortcut//
	////////////////////
	batch_normalization_layer *bn_8a = new batch_normalization_layer("bn_8a",
		7,    //input_dim		
		512, phrase);   //channel
	bn_8a->bottoms << relu7_c->tops[0];
	bn_8a->set_params_init_value("scale", constant, 1.0);
	bn_8a->set_params_init_value("shift", constant, 0.0);
	net << bn_8a;

	bin_activation_layer *ba_8a = new bin_activation_layer("ba_8a",
		7,    //input_dim
		512,	   //channel
		1,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_8a = new bin_conv_layer("bc_8a",
		7,    //input_dim
		512,	   //channel
		512,   //output_channel
		1,	   //kernel_size
	...
	batch_normalization_layer *bn_8b = new batch_normalization_layer("bn_8b",
		7,    //input_dim		
		512, phrase);   //channel
	bn_8b->bottoms << relu7_c->tops[0];
	bn_8b->set_params_init_value("scale", constant, 1.0);
	bn_8b->set_params_init_value("shift", constant, 0.0);
	net << bn_8b;

	bin_activation_layer *ba_8b = new bin_activation_layer("ba_8b",
		7,    //input_dim
		512,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_8b = new bin_conv_layer("bc_8b",
		7,    //input_dim
		512,	   //channel
		512,   //output_channel
		3,	   //kernel_size
	...
	batch_normalization_layer *bn_8c = new batch_normalization_layer("bn_8c",
		7,    //input_dim		
		512, phrase);   //channel
	...
	bin_activation_layer *ba_8c = new bin_activation_layer("ba_8c",
		7,    //input_dim
		512,	   //channel
		3,	   //kernel_size
		1,	   //stride
	...
	bin_conv_layer *bc_8c = new bin_conv_layer("bc_8c",
		7,    //input_dim
		512,	   //channel
		512,   //output_channel
		3,	   //kernel_size
	...
	eltwise_layer *el_8 = new eltwise_layer("el_8",
		7,
		512, phrase);
	...
	average_pooling_layer *ap = new average_pooling_layer("pool_ave",
		7,  //input_dim
		512,   //channel
		7,	  //kernel_size
		1, phrase);	  //stride
